...
```{r MCRloadings, fig.cap="Spectres purs, loadings MCR", fig.width= 5, fig.height= 3}
###################
fmr <- dim(tea.als$S)
...
```{r MCRscores, fig.cap="Evolution cinetique des spectres purs", fig.width= 5, fig.height= 3}
##
